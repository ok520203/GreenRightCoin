...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/greenrightcoin/greenrightcoin>";
    const std::string URL_WEBSITE = "<https://greenrightcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("GreenRightCoin version %s\n", FormatFullVersion());
}
