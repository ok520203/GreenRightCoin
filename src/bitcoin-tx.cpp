...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s greenrightcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  greenrightcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded greenrightcoin transaction") + "\n" +
              "  greenrightcoin-tx [options] -create [commands]   " + _("Create hex-encoded greenrightcoin transaction") + "\n" +
              "\n";
